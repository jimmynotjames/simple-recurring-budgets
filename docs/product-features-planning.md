...
- **Acceptance Criteria:**
  ...
  - **Calendar section** — Week Starts On picker: shows a confirmation alert before applying the selected weekday (the alert states the cascade: all weekly budgets regroup immediately, history included; biweekly budgets keep their own cycle); confirmed value writes to `AppSettings.weekStartDay`; see F-5.01 for week-start semantics.
