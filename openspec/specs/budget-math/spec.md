...
Specifies the pure budget math service layer (`PeriodCalculator` + `BudgetCalculator`) that computes period boundaries, remaining amounts, carry-over rolls, and scheduled resets. All computation is stateless and has no SwiftData or SwiftUI dependencies.
...
- **THEN** the biweekly anchor is Sunday 2026-03-29 (most recent Sunday at or before 2026-04-01), and the current biweekly period start is Sunday 2026-04-12 (14 days after anchor)
...
#### Scenario: Biweekly reset cadence on a daily budget

- **WHEN** the budget period is daily, reset cadence is biweekly, week start is Sunday, last reset date is Sunday 2026-04-05, and now is Sunday 2026-04-19 (14 days later)
- **THEN** a reset is detected with new reset date of Sunday 2026-04-19

#### Scenario: Monthly reset cadence on a weekly budget

- **WHEN** the budget period is weekly, reset cadence is monthly, week start is Monday, last reset date is 2026-03-02 (a Monday), and now is 2026-04-06 (the first Monday in April)
- **THEN** a reset is detected with new reset date of 2026-04-06
...
- **WHEN** carry-over is 0.00, allocation is 20.00/day, reset cadence is weekly, last processed date is 6 days before this Sunday, last reset date is last Sunday, expenses over those 6 days total 100.00, and now is this Sunday (a new reset boundary)
