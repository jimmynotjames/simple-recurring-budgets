...
SwiftData entities, enums, and related rules for budgets and expense items. Synced from change `rewrite-budget-calculations` (2026-05-15). Updated from change `specific-dates-period` (2026-05-18).
