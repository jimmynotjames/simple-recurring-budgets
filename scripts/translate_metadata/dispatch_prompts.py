...
CULTURAL_NOTES: dict[str, str] = {
    ...
    "ja": "Register: keep polite-friendly です/ます — Japanese app copy stays polite regardless of audience age; plain/casual form would read as off, not young. Get the young, modern feel through light, soft, approachable phrasing (Apple Japan's voice), not through dropping politeness. Avoid stiff keigo. Use katakana for loanwords (e.g. アプリ). Positioning: Japanese app copy rewards quiet politeness, tidiness, and 'kawaii-adjacent' gentle warmth over bold claims — the calm/tidy/quietly-warm traits are a perfect fit; let them lead and keep superlatives out. Short, soft sentences; the em-dash habit of English does not translate, restructure instead.",
    "ko": "Register: use the polite-friendly 해요체 — Korean app copy stays polite across ages; the plain 반말 form would read as wrong, not young. The young, modern feel comes from clean, light phrasing and natural English loanwords (common in Korean tech/finance), not from dropping politeness. Match Apple Korea's app voice. Positioning: clean, modern, lightly warm; lean into light/quick/effortless; avoid heavy or preachy framing about saving money.",
