...
CULTURAL_NOTES: dict[str, str] = {
    "ar-SA": "Write in Modern Standard Arabic (MSA), not a regional dialect. Register: MSA marketing addresses all audiences with the same standard forms — there is no casual/formal pronoun split to toggle, so achieve the young, modern feel through fresh, light, contemporary phrasing rather than colloquialism. Right-to-left: keep punctuation and any Latin brand tokens correctly placed for RTL. Never begin a line, sentence, or paragraph with a Latin token like Wren — a line that starts with a strong left-to-right word mis-renders and flings the token to the visual end; lead with a native (RTL) word and keep the brand mid-sentence. Warm but clean register. Positioning: budgeting and saving carry positive, prudent-stewardship connotations here — frame Wren as helping you manage money wisely and with dignity, never as fixing overspending. Avoid imagery that implies the user is bad with money.",
    ...
    "he": "Modern Hebrew. Right-to-left: keep punctuation and any Latin brand tokens correctly placed for RTL. Never begin a line, sentence, or paragraph with a Latin token like Wren — a line that starts with a strong left-to-right word mis-renders and flings the token to the visual end; lead with a native (RTL) word and keep the brand mid-sentence. Friendly register.",
    ...
    "ur-PK": "Conversational Urdu in Nastaliq (Arabic) script, marketing to young adults. Keep the polite \"آپ\" — Urdu app copy uses \"آپ\" across audiences; \"تم\"/\"تو\" reads as overfamiliar or rude, not young. Right-to-left: keep punctuation and any Latin brand/tech tokens (\"Wren\", \"iCloud\") correctly placed for RTL. Never begin a line, sentence, or paragraph with a Latin token like Wren — a line that starts with a strong left-to-right word mis-renders and flings the token to the visual end; lead with a native (RTL) word and keep the brand mid-sentence (note: Urdu postpositions like \"کے ساتھ\" still leave Wren line-initial, so front a different word). Positioning: budgeting and saving carry positive, prudent-stewardship connotations — frame Wren as managing money wisely and with dignity, never as fixing overspending. Get the modern feel from warm, light phrasing and natural English loanwords (\"budget\", \"track\"), not informal pronouns. Keyword/ASO: many users search in English or Roman-Urdu transliteration, so mix natural Urdu-script terms with the common English loanwords people actually type.",
