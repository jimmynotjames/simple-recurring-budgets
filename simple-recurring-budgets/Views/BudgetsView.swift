    ...
    private var accessibilityLabel: String {
        if amount > 0 {
            return String(
                ...
                defaultValue: "\(display.amount) surplus carry-over",
        ...
        if amount < 0 {
            return String(
                ...
                defaultValue: "\(display.amount) deficit carry-over",
...
private extension BudgetPeriod {
    var listLabel: String {
        switch self {
        case .daily:
            return String(localized: "period.daily", defaultValue: "Daily",
                          comment: "Budget period label for daily budgets in the list")
        case .weekly:
            return String(localized: "period.weekly", defaultValue: "Weekly",
                          comment: "Budget period label for weekly budgets in the list")
        case .biweekly:
            return String(localized: "period.biweekly", defaultValue: "Biweekly",
                          comment: "Budget period label for biweekly budgets in the list")
        case .monthly:
            return String(localized: "period.monthly", defaultValue: "Monthly",
