...
struct BudgetCalculatorRemainingTests {
    ...
    @Test func remaining_underBudget() {
    ...
    @Test func remaining_overBudget() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
    ...
    @Test func remaining_expensesFromOtherPeriodsExcluded() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
    ...
    @Test func remaining_addFundsReducesExpenseTotal() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
...
struct BudgetCalculatorRollCarryOverTests {
    ...
    @Test func rollCarryOver_singleBoundaryCrossed() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
    ...
    @Test func rollCarryOver_multiBoundaryCatchUp() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
    ...
    @Test func rollCarryOver_negativeCarryOverAccumulates() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
    ...
    @Test func rollCarryOver_weeklyPeriod_correctExpenseBucketing() {
        let container = try! TestModelContainer.make()
        let ctx = ModelContext(container)
